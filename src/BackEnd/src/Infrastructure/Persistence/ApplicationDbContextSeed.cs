namespace GrowATree.Infrastructure.Persistence
{
    ...
    public static class ApplicationDbContextSeed
    {
        ...
        {
            var defaultUser = new User { UserName = "user1", Email = "user1@trees.com", City = "Благоевград", EmailConfirmed = true, ProfilePictureUrl = "https://res.cloudinary.com/dzivpr6fj/image/upload/v1602432685/GrowATree/avatar_dpskn1.png" };
            var defaultUser1 = new User { UserName = "user2", Email = "user2@trees.com", City = "Благоевград", EmailConfirmed = true, ProfilePictureUrl = "https://res.cloudinary.com/dzivpr6fj/image/upload/v1602432685/GrowATree/avatar_dpskn1.png" };
            var defaultUser2 = new User { UserName = "user3", Email = "user3@trees.com", City = "Благоевград", EmailConfirmed = true, ProfilePictureUrl = "https://res.cloudinary.com/dzivpr6fj/image/upload/v1602432685/GrowATree/avatar_dpskn1.png"};
        ...
        {
            var storeUser = new User { UserName = "storeUser1", Email = "storeUser1@trees.com", City = "Благоевград", PhoneNumber = "0898700133", EmailConfirmed = true, ProfilePictureUrl = "https://res.cloudinary.com/dzivpr6fj/image/upload/v1602432685/GrowATree/avatar_dpskn1.png"};
            var storeUser1 = new User { UserName = "storeUser2", Email = "storeUser2@trees.com", City = "Благоевград", PhoneNumber = "0898700134", EmailConfirmed = true, ProfilePictureUrl = "https://res.cloudinary.com/dzivpr6fj/image/upload/v1602432685/GrowATree/avatar_dpskn1.png"};
            var storeUser2 = new User { UserName = "storeUser3", Email = "storeUser3@trees.com", City = "Благоевград", PhoneNumber = "0898700135", EmailConfirmed = true, ProfilePictureUrl = "https://res.cloudinary.com/dzivpr6fj/image/upload/v1602432685/GrowATree/avatar_dpskn1.png"};
