...
const FileInput = ({onChange}) => {
    return (
        <div className="box text-center">
            <input onChange={onChange} type="file" name="file-5[]" id="file-5" accept='image/*' className="inputfile inputfile-4 d-none" data-multiple-caption="{count} files selected" multiple />
